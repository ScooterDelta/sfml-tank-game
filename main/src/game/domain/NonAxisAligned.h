    ...
    public:
        ...
        virtual Vector2D getFrontLeft() {
            ...
            float xLocation = (float) (DrawableObject::getPosition().x -
                                       _cornerDistance *
                                       cos((DrawableObject::getDirection() - _cornerAngle) * _pi / 180));
            float yLocation = (float) (DrawableObject::getPosition().y -
                                       _cornerDistance *
                                       sin((DrawableObject::getDirection() - _cornerAngle) * _pi / 180));
        ...
        virtual Vector2D getBackLeft() {
            ...
            float xLocation = (float) (DrawableObject::getPosition().x -
                                       _cornerDistance *
                                       cos((180 + DrawableObject::getDirection() + _cornerAngle) * _pi / 180));
            float yLocation = (float) (DrawableObject::getPosition().y -
                                       _cornerDistance *
                                       sin((180 + DrawableObject::getDirection() + _cornerAngle) * _pi / 180));
