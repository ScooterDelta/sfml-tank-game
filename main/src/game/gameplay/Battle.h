...
namespace game::gameplay {
  ...
  private:
    ...
    high_resolution_clock::time_point _missileTimer1;
    //! Time between _tank2 Missiles.
    high_resolution_clock::time_point _missileTimer2;
    //! Time between _tank1 Mines.
    high_resolution_clock::time_point _mineTimer1;
    //! Time between _tank2 Mines.
    high_resolution_clock::time_point _mineTimer2;
    //! The game score.
    /*!
